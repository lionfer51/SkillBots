...
String GOOGLE_SCRIPT_ID = "AKfycbzVHflWoHqtGLXJhWalYhjvqGrU3BikZgcqw78XyUzVXLSWU5WBmXjkIvS9Xf9WEp8Y";
...
void loop() {
  ...
  if(Serial.available()){
    ...
    Serial.println(escribirApp(texto));
  }
}

String escribirApp(String texto){
